            ...
            <div class="row text-center">
                <div class="form">
                    <form class="login-form" method="post" action="update-cat.php">
                        <label class="first" for="type">Category : <input id="type" type="text" placeholder="Enter Category" name="cat" required></label><br>
                        ...
                        <button type="submit" class="btn btn-details btn-primary" name="submit" value="Update"> Update </button><br>
